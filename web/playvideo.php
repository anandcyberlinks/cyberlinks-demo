    ...
    <div class="row">
        <div class="col-sm-8">
            <div class="video-info small">
                ...
                <h1>Awesome Film Perfomance</h1>

                <span class="views"><i class="fa fa-eye"></i>691</span>
                <a data-toggle="modal" data-target="#loginmodal" class="option" href="javascript:void(0)" action="like" id="2508"><span class="likes"><i class="fa fa-thumbs-up"></i><label class="likevideo2508">115</label></span></a>
            </div>

            <div class="videoWrapper player">
                <iframe src="//player.vimeo.com/video/106786265" width="1920" height="1080" frameborder="0" title="E N V O Y" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>	                	
            </div>
        ...
        <div class="col-sm-4 sidebar">
            <div class="widget mars-subscribox-widget"><h4 class="widget-title">Social Subscribox</h4>			        <div class="social-counter-item">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" role="form" action="" name="mars-subscribe-form" id="mars-subscribe-form">
                                    ...
                                    <input type="hidden" id="mars_subscrib" name="mars_subscrib" value="9f99a467da"><input type="hidden" name="_wp_http_referer" value="/video/awesome-film-perfomance/">				  <button type="submit" class="btn btn-primary">Register</button>
                                    <input type="hidden" name="submit-label" value="Register">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                    <input type="hidden" name="referer" id="referer" value="2508">
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div id="post-right-mars-posts-sidebar-widget-3-2369" class="post-2369 post type-post status-publish format-standard has-post-thumbnail hentry category-music tag-band tag-live tag-music-3 tag-perfomance item">
                    <a title="Watch This Awesome Music Perfomance" href="http://videotube.marstheme.com/watch-this-awesome-music-perfomance-2/"><img width="360" height="240" src="http://videotube.marstheme.com/wp-content/uploads/2014/03/DeathtoStock_Band10-360x240.jpg" class="img-responsive wp-post-image" alt="DeathtoStock_Band10"></a>	            	
                    <div class="post-header">              	         	
                ...
                <div id="post-right-mars-posts-sidebar-widget-3-2368" class="post-2368 post type-post status-publish format-standard has-post-thumbnail hentry category-viral-videos tag-fail tag-funny tag-videos tag-viral item">
                    ...
                    <div class="col-xs-6 item mars-videos-sidebar-widget-3-1721">
                        <div class="item-img">
                            <a title="Titanfall Launch Trailer" href="http://videotube.marstheme.com/video/titanfall-launch-trailer/"><img width="165" height="108" src="http://videotube.marstheme.com/wp-content/uploads/2014/03/game6-165x108.jpg" class="img-responsive wp-post-image" alt="game6"></a>						<a href="http://videotube.marstheme.com/video/titanfall-launch-trailer/"><div class="img-hover"></div></a>
                        </div>	            	
                        <h3><a title="Titanfall Launch Trailer" href="http://videotube.marstheme.com/video/titanfall-launch-trailer/">Titanfall Launch Trailer</a></h3>
                ...
                <div class="item mars-videos-sidebar-widget-4-2132">
                    <div class="item-img">
                        <a title="HD Music Nexus Playlist" href="http://videotube.marstheme.com/video/hd-music-nexus-playlist/"><img width="360" height="240" src="http://videotube.marstheme.com/wp-content/uploads/2014/07/hd-music-nexus-playlist-360x240.jpg" class="img-responsive wp-post-image" alt="HD Music Nexus Playlist"></a>							<a href="http://videotube.marstheme.com/video/hd-music-nexus-playlist/"><div class="img-hover"></div></a>
                    </div>		            	
                    <h3><a title="HD Music Nexus Playlist" href="http://videotube.marstheme.com/video/hd-music-nexus-playlist/">HD Music Nexus Playlist</a></h3>
                    <div class="meta"><span class="date">4 months ago</span>
                        <span class="views"><i class="fa fa-eye"></i>2578</span><span class="heart"><i class="fa fa-heart"></i>358</span>
