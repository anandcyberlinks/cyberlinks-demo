<div class="wrapper row-offcanvas row-offcanvas-left">
	...
	<aside class="right-side">                
		...
		<section class="content-header">
            ...
            <li><a href="<?php echo base_url() ?>transcode"><i class="fa fa-laptop"></i><?php echo $welcome->loadPo('Transcode') ?></a></li>
            <li class="active"><?php echo $welcome->loadPo('Add Transcode') ?></li>
        </ol>
		</section>
		<!-- Main content -->
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							<div class="box-header">
								<h3 class="box-title"><?php echo $welcome->loadPo('Add').''.$welcome->loadPo('Transcode'); ?></h3>
							...
							<form action="" id="TranscodeTranscodeoprForm" method="post" accept-charset="utf-8">
								...
								<div class="box-body">
									<div class="row">
										<div class="form-group col-lg-3">
											<div class="input text">
												...
												<input name="flavor_name" class="form-control" placeholder="<?php echo $welcome->loadPo('Flavor').' '.$welcome->loadPo('Name'); ?>" maxlength="255" type="text" id="TranscodeFlavorName" value="<?php echo set_value('flavor_name'); ?>" />
											...
											<div class="input select">
												...
												<select name="device_name" class="form-control" placeholder="<?php echo $welcome->loadPo('Device'); ?>" id="TranscodeDeviceName">
													<option value="">--<?php echo $welcome->loadPo('Select Device Name'); ?>--</option>
														...
														<option value="iphone" <?php if(set_value('device_name') == 'iphone'){ echo 'selected="selected"';} ?> >Iphone</option>
														<option value="andriod" <?php if(set_value('device_name') == 'andriod'){ echo 'selected="selected"';} ?>>Andriod</option>
														<option value="windows" <?php if(set_value('device_name') == 'windows'){ echo 'selected="selected"';} ?>>Windows</option>
														<option value="blackberry" <?php if(set_value('device_name') == 'blackberry'){ echo 'selected="selected"';} ?>>Blackberry</option>
									...
									<div class="row">
										<div class="form-group col-lg-3">
											<div class="input text">
												...
												<input name="bitrate_type" class="form-control" placeholder="<?php echo $welcome->loadPo('Bitrate').' '.$welcome->loadPo('Type'); ?>" maxlength="50" type="text" id="TranscodeBitrateType" value="<?php echo set_value('bitrate_type'); ?>"/>
										...
										<div class="form-group col-lg-3">
											<div class="input number">
												...
												<input name="bitrate" class="form-control" placeholder="<?php echo $welcome->loadPo('Bitrate'); ?>" type="number" id="TranscodeBitrate" value="<?php echo set_value('bitrate'); ?>"/>
									...
									<div class="row">
										<div class="form-group col-lg-3">
											...
											<div class="input number">
												<input name="video_bitrate" class="form-control" placeholder="<?php echo $welcome->loadPo('Video').' '.$welcome->loadPo('Bitrate'); ?>" type="number" id="TranscodeVideoBitrate" value="<?php echo set_value('video_bitrate'); ?>"/>
										...
										<div class="form-group col-lg-3">
											...
											<div class="input number">
												<input name="audio_bitrate" class="form-control" placeholder="<?php echo $welcome->loadPo('Audio').' '.$welcome->loadPo('Bitrate'); ?>" type="number" id="TranscodeAudioBitrate" value="<?php echo set_value('audio_bitrate'); ?>"/>
									...
									<div class="row">
										<div class="form-group col-lg-3">
											<div class="input text">
												...
												<input name="width" class="form-control" placeholder="<?php echo $welcome->loadPo('Width'); ?>" maxlength="50" type="text" id="TranscodeWidth" value="<?php echo set_value('category'); ?>"/>
										...
										<div class="form-group col-lg-3">
											<div class="input text">
												...
												<input name="height" class="form-control" placeholder="<?php echo $welcome->loadPo('Height'); ?>" maxlength="50" type="text" id="TranscodeHeight" value="<?php echo set_value('height'); ?>"/>
									...
									<div class="row">
										<div class="form-group col-lg-3">
											<div class="input number">
												...
												<input name="frame_rate" class="form-control" placeholder="<?php echo $welcome->loadPo('Frame Rate (FPS)'); ?>" type="number" id="TranscodeFrameRate" value="<?php echo set_value('frame_rate'); ?>"/>
										...
										<div class="form-group col-lg-3">
											<div class="input number">
												...
												<input name="keyframe_rate" class="form-control" placeholder="<?php echo $welcome->loadPo('Keyframe Rate'); ?>" type="number" id="TranscodeKeyframeRate" value="<?php echo set_value('keyframe_rate'); ?>"/>
								...
								<div class="box-footer">
									...
									<a href="<?php echo base_url();?>transcode" class="btn btn-default"><?php echo $welcome->loadPo('Cancel'); ?></a>
								</div>
							</form>
						</div><!-- /.box -->
					</div><!--/.col (left) -->
