    ...
    <aside class="right-side"> 
        ...
        <section class="content">
			...
			<h3 class="box-title">Search Videos</h3>
                            ...
                            <!-- form start -->
                            <form  method="post" action="<?php echo base_url(); ?>advertising/vdo" onsubmit="return date_check();" id="searchIndexForm" name="searchIndexForm" accept-charset="utf-8">
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-body table-responsive">
                                ...
                                <div><a class="linkClickVdo"   data-toggle="modal" data-backdrop="static" href="#tester" data-toggle="modal" value='Edit'>Edit</a>
                                ...
                                <table id="example2" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>select</th>
                                            <th width="15px"><a href="<?php echo base_url(); ?>advertising/vdo/title/<?php echo (!empty($show_t)) ? $show_t : 'asc'; ?>"><?php echo $welcome->loadPo('Title') ?></a></th>
                                            <th><a href="<?php echo base_url(); ?>advertising/vdo/category/<?php echo (!empty($show_c)) ? $show_c : 'asc'; ?>"><?php echo $welcome->loadPo('Category') ?></a></th>
                                            <th><a href="<?php echo base_url(); ?>advertising/vdo/user/<?php echo (!empty($show_u)) ? $show_u : 'asc'; ?>"><?php echo $welcome->loadPo('User') ?></a></th>
                                            <th><a href="<?php echo base_url(); ?>advertising/vdo/status/<?php echo (!empty($show_s)) ? $show_s : 'asc'; ?>"><?php echo $welcome->loadPo('Status') ?></a></th>
                                            <th><?php echo $welcome->loadPo('Preview') ?></th>
                                            <th><a href="<?php echo base_url(); ?>advertising/vdo/created/<?php echo (!empty($show_ca)) ? $show_ca : 'asc'; ?>"><?php echo $welcome->loadPo('Publish Date') ?></a></th>
            ...
            <div class="row">
                <div class="col-sm-10" style="margin-left:10px">
                                <div class="form-group">
                                    ...
                                    <input type='hidden' name="vdo_cuepoint" id="vdo_cuepoint" value="1">
    ...
    {        
       ...
       if (state==="PAUSED") {
        ...
        //console.log(pos);
                    ...
                    $(".hh").val(splitArrTime[0]);
                    $(".mm").val(splitArrTime[1]);
                    $(".ss").val(splitArrTime[2]);
