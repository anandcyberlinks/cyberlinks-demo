<?php
$sort = $sort_by = $this->uri->segment(4);
if ($sort == 'DESC') {
    $sort = 'ASC';
...
<?php echo $this->session->flashdata('message'); ?>				
        ...
        <?php } ?>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url() ?>package/video_detail/<?php echo $subData->id; ?>">Manage Videos, </a>Total <?php echo $welcome->countVideo($subData->id); ?>
                                                </td>
