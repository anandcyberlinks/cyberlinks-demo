                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="169" height="45" align="center">
                                                                    <div class="imgpop">
                                                                            <img src="<?= base_url() . 'assets/img/multitv.png' ?>" border="0" width="169" height="45" style="display:block; border:none; outline:none; text-decoration:none;">
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;" st-content="fulltext-content">
                                                                    You have successfully registered with us, <a href="<?= $_GET['link'] ?>">Click here</a> to verify your Email
                                                                </td>
                                                            </tr>
                                                            <!-- End of content -->
                                                        </tbody>
