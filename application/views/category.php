                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-3">
                                            <div class="input text">
                                                ...
                                                <input name="category_name" class="form-control" placeholder="<?php echo $welcome->loadPo('Category') . ' ' . $welcome->loadPo('Name');
                ; ?> " type="text" id="searchCategoryName" value="<?php echo (isset($search_data['category_name'])) ? $search_data['category_name'] : ''; ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-3">
                                            <div class="input select">
                                                ...
                                                <select name="parent_id" class="form-control" placeholder="Parent Category" id="searchParentId">
                                                    ...
                                                    <?php foreach ($allParentCategory as $cat) { ?>
                                                        <option value="<?php echo $cat->id; ?>" <?php if (isset($search_data['parent_id']) && $cat->id == $search_data['parent_id']) {
