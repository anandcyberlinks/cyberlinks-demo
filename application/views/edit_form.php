                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <div class="input-group"><label><?php echo $welcome->loadPo('Form Name') ?></label>
                            <input type="text" name="form_name" value="<?php echo $formdata[0]->form_name; ?>" placeholder="<?php echo $welcome->loadPo('Form Name') ?>" class="form-control">
                        ...
                        <input type="checkbox" name="status" value="1" <?php if($formdata[0]->status == 1){ echo "checked"; } ?> />
                        </div><label for="name" generated="true" class="error"></label><br>
                        <input type="submit" name="submit"value="<?php echo $welcome->loadPo('Update') ?>" class="btn btn-success">&nbsp;
