                ...
                <div class="box-header">
                    <div class="box-tools">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a class="thumb_upload" href="#myModal1" data-toggle="modal" data-backdrop="static"  content_id="<?php echo $ads_id; ?>"><?php echo $welcome->loadPo('Upload'); ?></a></li>								
                            <?php /* ?><li><a class="thumb_crop" content_id="<?php echo $ads_id; ?>" href="#myModal2" data-backdrop="static" data-toggle="modal" defThumbVal="<?php echo $defaultThumbInfo; ?>" ><?php echo $welcome->loadPo('New') . " " . $welcome->loadPo('Crop'); ?> </a></li>								
                        ...
                        <tbody>
                            ...
                            foreach ($thumbnails_info as $thumb_val) {
                                ...
                                <tr>
                                    ...
                                    } ?>" href="<?php echo base_url(); ?>ads/set_defltimage?cid=<?php echo $ads_id; ?>&fid=<?php echo $thumb_val->id; ?>&redirect_url=<?php echo current_full_url(); ?>"><?php echo $welcome->loadPo('Set as Default'); ?></a>
                                    ...
                                    } ?>" href="<?php echo base_url(); ?>video/delele_thumbimage?cid=<?php echo $ads_id; ?>&fid=<?php echo $thumb_val->id; ?>&redirect_url=<?php echo current_full_url(); ?>" ><?php echo $welcome->loadPo('Delete'); ?></a></td>
                                </tr>
    <?php $i++;
} ?>
                        </tbody>
...
<?php echo $welcome->loadPo('Thumbnail') . " : " . $welcome->loadPo('Upload'); ?>
            ...
            <form action="<?php echo base_url() ?>ads/upload_thumb" id="videoUploadForm" class="filse" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body ">  
                <div class="jc-demo-box">  
                    <form action="<?php echo base_url() ?>ads/crop_thumb" method="post" onsubmit="return checkCoords();">
