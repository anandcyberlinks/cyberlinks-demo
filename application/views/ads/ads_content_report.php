<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side"> 
        ...
        <div class="col-md-3 col-sm-4">
            Export
        <a target='_blank' href='<?php echo base_url()?>ads_analytics/export/r/pdf/<?php echo $sort_i;?>/<?php echo $sort_by;?>/type/content'  title='pdf'><i class="fa fa-fw fa-file-text-o"></i></a>
        <a target='_blank' href='<?php echo base_url()?>ads_analytics/export/r/csv/<?php echo $sort_i;?>/<?php echo $sort_by;?>/type/content' title='csv'><i class="fa fa-fw fa-list-alt"></i></a>
        </div>     
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
