 <script type='text/javascript' src='https://www.google.com/jsapi'></script>   
  ...
  <aside class="right-side">
	...
	<div class="row">
         <div class="col-lg-8">
            Export
        <a target='_blank' href='<?php echo base_url()?>ads_analytics/export/r/pdf/<?php echo $sort_i;?>/<?php echo $sort_by;?>/type/region/country/<?php echo $country_code;?>'  title='pdf'><i class="fa fa-fw fa-file-text-o"></i></a>
        <a target='_blank' href='<?php echo base_url()?>ads_analytics/export/r/csv/<?php echo $sort_i;?>/<?php echo $sort_by;?>/type/region/country/<?php echo $country_code;?>' title='csv'><i class="fa fa-fw fa-list-alt"></i></a>
        </div>  
