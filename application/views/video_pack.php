                        ...
                        <div class="box box-primary">
                            ...
                            <form  method="post" action="<?php echo base_url(); ?>package/addVideo/24" onsubmit="return date_check();" id="searchIndexForm" name="searchIndexForm" accept-charset="utf-8">
                                ...
                                <div class="box-footer">
                                    ...
                                    <div class="pull-right"><a href="<?php echo base_url()."package/video_detail/".$this->uri->segment(3); ?>" class="btn btn-primary">Back To Package</a></div>
                                </div>
                            </form>
                        </div><!-- /.box -->
                    </div><!--/.col (left) -->
                                ...
                                <table id="example2" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="<?php echo $value->id ?>">
                                                ...
                                                <td  width="150"> 
                                                    <a href="#" class="link" links="<?php echo base_url(); ?>package/VideoPack/<?php echo $this->uri->segment(3)."/".$value->id; ?>" ><?php echo $welcome->loadPo('Add') ?></a>
                                                </tr>
                                        <?php } ?>
                                    </tbody>
