        ...
        <section class="content" id="customCss">
              ...
              <div class="box box-primary">
                <div class="box-header">
                 <!--   <div class="widget-header logo"></div>-->
                    <h3 class="timeHeading pull-left">Countries</h3>
          <div class="mailbox-controls pull-right">
              ...
              <div class="dashboard" id="big-numbers-container">
					...
					<div class="big-numbers three-column">
                                          <div id="draw-events-served" class="select">Total Users</div>
					...
					<div class="big-numbers three-column">
						<div id="draw-events-served" class="select">New Users</div>
              ...
              <div class="box">
                <div class="box-body">
                  <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                    ...
                    <thead>
                      <tr role="row"><th style="width: 167px;">Country</th><th>Total Session</th><th>Total Users</th><th>New Users</th></tr>
                    </thead>
                    <tbody>
                    <tr role="row" class="odd">
                        <td class="sorting_1">INDIA</td>
                        <td>1,562</td>
                        <td>359</td>
                        <td>90</td>  
                    </tr>
                    <tr role="row" class="odd">
                        <td class="sorting_1">Aus</td>
                        <td>1,562</td>
                        <td>359</td>
                        <td>90</td>  
                      </tr>
                    <tr role="row" class="odd">
                        <td class="sorting_1">US</td>
                        <td>1,562</td>
                        <td>359</td>
                        <td>90,924</td>  
                      </tr>
                    <tr role="row" class="odd">
                        <td class="sorting_1">CANDA</td>
                        <td>1,562</td>
                        <td>359</td>
                        <td>90</td>  
                      </tr>
