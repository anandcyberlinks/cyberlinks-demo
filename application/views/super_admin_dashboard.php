        ...
        <div class="row">
            <div class="col-lg-2 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3>
                            <?php echo $videos_count > 0 ? $videos_count : 0  ?>
                        </h3>
                        <p>
                    ...
                    <a href="<?php echo base_url() ?>super_admin/all_video" class="small-box-footer">
            ...
            <div class="col-lg-2 col-xs-6">
                ...
                <div class="small-box bg-light-blue">
                    <div class="inner">
                        <h3>
                            <?php echo $content_provider_count > 0 ? $content_provider_count : 0 ?>
                        </h3>
                        <p>
                           <?php echo $welcome->loadPo('Content Providers'); ?> 
                        </p>
                    </div>
                    <div class="icon">
                    ...
                    <a href="<?php echo base_url() ?>video?filter=youtube" class="small-box-footer">
                        <?php echo $welcome->loadPo('Content Provider List'); ?> <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            <div class="col-lg-2 col-xs-6">
                ...
                <div class="small-box bg-fuchsia">
                    <div class="inner">
                        <h3>
                            <?php echo $advertisers_count > 0 ? $advertisers_count : 0 ?>
                        </h3>
                        <p>
                           <?php echo $welcome->loadPo('Total Advertiser'); ?> 
                        </p>
                    </div>
                    <div class="icon">
                    ...
                    <a href="<?php echo base_url() ?>video/video_status" class="small-box-footer">
                        <?php echo $welcome->loadPo('Advertiser List'); ?> <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            <div class="col-lg-2 col-xs-6">
                ...
                <div class="small-box bg-red">
                    <div class="inner">
                        ...
                        <p>
                            <?php echo $welcome->loadPo('Total Publishers'); ?>
                        </p>
                    </div>
                    <div class="icon">
                    ...
                    <a href="<?php echo base_url() ?>video/video_status?filter=completed" class="small-box-footer">
                        <?php echo $welcome->loadPo('All Publishers'); ?> <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div><!-- ./col -->
            <div class="col-lg-2 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    <div class="inner">
                        <h3>
                            <?php echo $customers_count > 0 ? $customers_count : 0 ?>
                        </h3>
                        <p>
                            <?php echo $welcome->loadPo('Total Customers'); ?>
                        </p>
                    </div>
                    <div class="icon">
                    ...
                    <a href="<?php echo base_url() ?>video/video_status?filter=inprocess" class="small-box-footer">
                        <?php echo $welcome->loadPo('All Customers'); ?> <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div><!-- ./col -->
<!--            <div class="col-lg-2 col-xs-6">
