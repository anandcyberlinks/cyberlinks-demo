              ...
              <div class="box">
                <div class="box-body">
                  <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                    ...
                    <thead>
                      <tr role="row"><th style="width: 167px;">Platforn</th><th>Total Sessions</th><th>Total Users</th><th>New Users</th></tr>
                    </thead>
                    <tbody>
             ...
             <div class="box">
                <div class="box-body">
                  <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                    ...
                    <table class="table table-bordered table-striped dataTable" id="example1" role="grid" aria-describedby="example1_info">
                    <thead>
                      <tr role="row"><th style="width: 167px;">Platform Version</th><th>Total Sessions</th><th>Total Users</th><th>New Users</th></tr>
                    </thead>
                    <tbody>
                    <tr role="row" class="odd">
                        <td class="sorting_1">Galaxy S3</td>
