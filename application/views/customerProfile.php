...
<aside class="content-wrapper">
    ...
    <section class="content-header">
        <h1><?php echo $welcome->loadPo('Customer Profile') ?></h1> 
    </section>
    <span>
        <div id="msg_div">
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="<?php echo $data->image;?>" width="<?php echo $width ?>" height="<?php $height ?>"><br><br>
                                        <form action="<?php echo base_url() ?>customers/do_upload<?= ($this->uri->segment(3)) ? '/' . $this->uri->segment(3) : ''; ?>" method="post" enctype="multipart/form-data">
