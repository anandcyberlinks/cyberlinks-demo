                    ...
                    <div class="col-md-12">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="<?= ($this->uri->segment(3) === 'Basic') ? 'active' : '' ?>" ><a href="<?php echo base_url(); ?>video/videoOpr/Basic?action=<?php if (isset($id) && $id != "") {
                                ...
                                <?php /* ?><li class="<?= ($this->uri->segment(3) === 'Scheduling') ? 'active' : '' ?>" ><a href="<?php echo base_url(); ?>video/videoOpr/Scheduling?action=<?php if (isset($id) && $id != "") {
                                                ...
                                                echo $_GET['action'];
                                            } ?>"><?php echo $welcome->loadPo('Scheduling') ?></a></li> <?php */ ?>
                                <li class="<?= ($this->uri->segment(3) === 'Thumbnail') ? 'active' : '' ?>" ><a href="<?php echo base_url(); ?>video/videoOpr/Thumbnail?action=<?php if (isset($id) && $id != "") {
                                                echo base64_encode($id) . '&';
                                            } else {
                                                echo $_GET['action'];
