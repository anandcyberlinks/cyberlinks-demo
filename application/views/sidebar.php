    ...
    <section class="sidebar">
	    ...
	    <li class="treeview <?=(($this->uri->segment(1)=='video') || ($this->uri->segment(1)=='video_settings'))?'active':''?>">
                ...
                <ul class="treeview-menu">
                    <li class="<?=(($this->uri->segment(1)=='video') && ($this->uri->segment(2)==''))?'active':''?>"><a href="<?php echo base_url() ?>video"><i class="fa fa-angle-double-right"></i> <?php echo $welcome->loadPo('Video')." ".$welcome->loadPo('List'); ?></a></li>
