        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview <?=(($this->uri->segment(1)=='video') || ($this->uri->segment(1)=='video_settings'))?'active':''?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?=($this->uri->segment(2)=='bulkupload')?'active':''?>"><a href="<?php echo base_url() ?>video/bulkupload"><i class="fa fa-angle-double-right"></i>  <?php echo $welcome->loadPo('Bulk')." ".$welcome->loadPo('Upload')." ".$welcome->loadPo('Video'); ?></a></li>
