									...
									<div class="row">
										<div class="form-group col-lg-5">
											<div class="input text">
												...
												<input name="field_name" value="<?php echo $edit[0]->field_name; ?>" class="form-control" placeholder="<?php echo $welcome->loadPo('Field').' '.$welcome->loadPo('Name'); ?>" maxlength="255" type="text" id="Category" value="<?php echo set_value('category'); ?>" onblur="category_check(this.value);" />
