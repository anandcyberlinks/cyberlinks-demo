					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							<div class="box-header">
								<h3 class="box-title"><?php echo $welcome->loadPo('Fields').' '.$welcome->loadPo('Edit'); ?></h3>
								...
								<div class="box-body">
									<div class="row">
										<div class="form-group col-lg-5">
											<div class="input text">
												...
												<input name="field_title" value="<?php echo $edit[0]->field_title; ?>" class="form-control" placeholder="<?php echo $welcome->loadPo('Field').' '.$welcome->loadPo('Title'); ?>" maxlength="255" type="text" id="Category" value="<?php echo set_value('category'); ?>" onblur="category_check(this.value);" />
									...
									<div class="row">
										<div class="form-group col-lg-5">
											<div class="input text">
												...
												<input name="field_name" value="<?php echo $edit[0]->field_name; ?>" class="form-control" placeholder="<?php echo $welcome->loadPo('Field').' '.$welcome->loadPo('Name'); ?>" maxlength="255" type="text" id="Category" value="<?php echo set_value('category'); ?>" onblur="category_check(this.value);" disabled/>
												...
												<select name="field_type" class="form-control" placeholder="Field Type" >
													...
													<?php 
														for($i=1; $i<count($fieldtype)+1;$i++){
															echo $fieldtype[$i];
															echo "<br>";?>
														  <option value="<?php echo $fieldtype[$i];?>" <?php if( $fieldtype[$i] == $edit[0]->field_type){ echo "selected"; }?>><?php echo $fieldtype[$i];?></option>
														<?php }
														?>
												</select>
									...
									<div class="row" id="options">
										<div class="form-group col-lg-5">
											<div class="input text">
												...
												<input name="field_options" value="<?php echo $edit[0]->field_options; ?>" class="form-control" id="myTags" type="text" placeholder="<?php echo $welcome->loadPo('Field').' '.$welcome->loadPo('Options'); ?>"  value="" /> 
											</div>
										</div>
									</div>
									 ...
									 <div class="row">    
										<div class="form-group col-lg-5">
											...
											<span align="left"><input type="checkbox" name="field_validate" value="1" <?php if($edit[0]->field_validate == '1'){ echo "checked"; } ?>/></span></label>
									...
									<div class="row">    
										<div class="form-group col-lg-5">
											...
											<span align="left"><input type="checkbox" name="status" value="1" <?php if($edit[0]->status == '1'){ echo "checked"; } ?> /></span></label>											
										</div>
									</div>
								</div><!-- /.box-body -->
